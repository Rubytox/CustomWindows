...
#include "buffer/OffscreenBuffer.h"
#include "util/ModularInt.h"
...
Logger *logger = new Logger(R"(C:\Users\cFAG\Documents\CustomWindows\log.txt)");
        ...
        int showCode)
{
    ...
    if (RegisterClass(&windowClass)) {
        ...
        if (window) {
            ...
            ModularInt xOffset(0, dimensions.width);
            ModularInt yOffset(0, dimensions.height);
            ...
            while (isRunning) {
                ...
                buffer->drawLine(300, 400, 700, 100);
